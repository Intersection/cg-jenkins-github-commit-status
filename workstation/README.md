...
This directory should house build tools for workstations. Use puppet, homebrew, etc, in the appropriate shell file to build out everything needed for this project on the given platform.
